...
public final class CentralAuthenticationServiceImpl extends AbstractCentralAuthenticationService {
    ...
    public ServiceTicket grantServiceTicket(
        ...
        this.redisServiceTicketRegistry.addTicket(serviceTicket);
    ...
    public Assertion validateServiceTicket(final String serviceTicketId, final Service service) throws AbstractTicketException {
        ...
        final ServiceTicket serviceTicket =  this.redisServiceTicketRegistry.getTicket(serviceTicketId);
        ...
        try {
            ...
            //清除票据
            redisServiceTicketRegistry.deleteTicket(serviceTicketId);
            return assertion;
